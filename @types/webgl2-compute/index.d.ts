...
interface WebGL2ComputeRenderingContext extends WebGL2RenderingContext {
  ...
  // missing constants
  readonly MAX_COMPUTE_WORK_GROUP_INVOCATIONS: number; //         = 0x90EB
  readonly MAX_COMPUTE_WORK_GROUP_COUNT: number; //               = 0x91BE
  readonly MAX_COMPUTE_WORK_GROUP_SIZE: number; //                = 0x91BF
