...
export class ParticleEngine {
  ...
  public createScene(): void {
    ...
    this._boundingBox = new BoundingBox(this._boundingBoxDimension, this._scene);

    // create the cross hair
    this._crossHair = new CrossHair(new THREE.Vector3(1.0, 1.0, 1.0),
      this._boundingBoxDimension, this._scene, this._settingsGui.getSettings());
